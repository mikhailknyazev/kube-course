...
curl https://hub.litmuschaos.io/api/chaos/1.13.6?file=charts/kube-aws/experiments.yaml | \
...
curl https://hub.litmuschaos.io/api/chaos/1.13.6?file=charts/generic/experiments.yaml | \
  sed "s/imagePullPolicy: Always/imagePullPolicy: IfNotPresent/" > \
